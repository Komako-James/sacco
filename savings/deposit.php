            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Record Savings Deposit</h4>
                    </div>
                    <div class="card-body">
                        <?php if ($error): ?>
                        ...
                        <form method="POST" id="depositForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="reference_no" name="reference_no" placeholder="e.g., Transaction ID">
                            </div>
                ...
                .then(data => {
                    if (data.success && data.accounts) {
                        ...
                        data.accounts.forEach(acc => {
                            ...
                            opt.text = `${acc.account_number} (${acc.account_type})`;
